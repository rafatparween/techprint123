...
// const Helppage = () => {
//   return (
//     <div className="bg-[#F0F0F0] flex items-center justify-center min-h-screen">
...
//           <p className="text-[20px] mb-4 text-black w-[700px] h-[48px]">
...
//             alt="Support Agents"
//             width={100}
//             height={100}src="data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAkGBwgHB
//             objectFit="cover"
//             className="ml-[139px]"
//           />
